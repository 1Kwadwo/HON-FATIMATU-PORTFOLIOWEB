                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    @if($video->thumbnail_url)
                        <div class="mb-6">
                            ...
                            <div class="max-w-md">
                                <img src="{{ $video->thumbnail_url }}" alt="{{ $video->title }}" class="w-full h-auto rounded-lg shadow-md">
                            </div>
                        </div>
                    @endif

                    <form action="{{ route('admin.home-videos.update', $video) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="description" id="description" rows="3"
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('description') border-red-300 @enderror">{{ old('description', $video->description) }}</textarea>
