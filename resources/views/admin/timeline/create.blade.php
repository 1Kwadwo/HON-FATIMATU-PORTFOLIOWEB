            ...
            <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mb-6">
                    <div class="flex items-center mb-4">
                        ...
                        <div>
                            <h1 class="text-3xl font-bold text-gray-900">Add Timeline Item</h1>
                            <p class="mt-2 text-gray-600">Create a new career timeline entry</p>
                        </div>
                    </div>
                </div>
                ...
                <!-- Form -->
                <form action="{{ route('admin.timeline.store') }}" method="POST" class="bg-white rounded-lg shadow-sm p-6">
                    @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="description" id="description" rows="4" required
                            class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                            placeholder="Describe this career milestone...">{{ old('description') }}</textarea>
                    </div>
